...
url_data_train = 'http://biostat.mc.vanderbilt.edu/wiki/pub/Main/DataSets/stressEcho.csv'
...
df_train.to_csv('vanderbilt_006_ucla_stress_echocardiography.csv', index = False)
