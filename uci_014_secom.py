...
url_data_train = 'https://archive.ics.uci.edu/ml/machine-learning-databases/secom/secom.data'
url_data_labels = 'https://archive.ics.uci.edu/ml/machine-learning-databases/secom/secom_labels.data'
...
df_labels = pandas.read_csv(data_labels, delimiter = '\s+', header = None, names = ['target'], index_col = False)
